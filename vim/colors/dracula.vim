...
hi TabLine ctermfg=69 ctermbg=234
hi TabLineSel ctermfg=233 ctermbg=68 gui=bold
...
hi Search ctermfg=16 ctermbg=75 cterm=NONE guifg=#282a36 guibg=#f1fa8c gui=underline
